...
import { Popover as InlinePopover } from "@base-ui/react/popover"
...
import { Check, Copy, Pipette, ChevronsUpDown } from "lucide-react"
...
function InlineColorPopoverContent({
  ...
  className,
  ...props
}: InlinePopover.Popup.Props &
  Pick<InlinePopover.Positioner.Props, "anchor" | "align" | "sideOffset">) {
  return (
    <InlinePopover.Portal>
      <InlinePopover.Positioner
        anchor={anchor}
        align={align}
